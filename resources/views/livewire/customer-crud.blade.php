<div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="border-t border-gray-200 pt-4 mb-4">
                            ...
                            <div class="flex justify-between text-sm mt-1">
                                ...
                                <span class="font-semibold text-green-600">${{ number_format($customer->total_spent, 2) }}</span>
                            </div>
                            <div class="flex justify-between text-sm mt-1">
                                <span class="text-gray-600">Customer Since:</span>
                                <span class="font-semibold text-gray-900">{{ $customer->created_at->format('M d, Y') }}</span>
                            </div>
                        </div>
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg max-w-2xl w-full mx-auto shadow-xl transform transition-all max-h-[90vh] overflow-y-auto">
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-lg max-w-md w-full mx-auto shadow-xl transform transition-all p-6">
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Are you sure you want to delete this customer? This action cannot be undone.</p>
